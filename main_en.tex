...
- ANN, Agent& \multirow{3}{*}{100\%}\\
 & &  & - Reranking&\\
 & &  & - Text to speech&\\
\hline 
%%%%%Student 2%%%%%%%%%%%
\multirow{3}{*}{2} & \multirow{3}{*}{Huỳnh Đức Nhân} & \multirow{3}{*}{2312420} & 
- Transformer, URAG& \multirow{3}{*}{100\%}\\
 & &  & - RAG-RL&\\
 & &  & - Speech to text&\\
\hline
%%%%%Student 3%%%%%%%%%%%
\multirow{3}{*}{3} & \multirow{3}{*}{Phạm Trần Minh Trí} & \multirow{3}{*}{2313622} & 
- LLM, LangChain& \multirow{3}{*}{100\%}\\
 & &  & - RAG-Reasoning&\\
 & &  & - Evaluation  &\\
\hline
\end{tabular}
...
\section*{Source code for the RAG chat app}
\addcontentsline{toc}{section}{Source code}

The source code can be accessed here: \url{https://github.com/phamtranminhtri/music_rag}
...
\input{text/section_1.tex}
\pagebreak
\input{text/section_2.tex}
\pagebreak
\input{text/section_3.tex}
\pagebreak
\input{text/section_4.tex}
\pagebreak
\input{text/section_5.tex}
\pagebreak
\input{text/section_6.tex}
\pagebreak
\input{text/section_7.tex}
\pagebreak
\input{text/section_8.tex}
\pagebreak
